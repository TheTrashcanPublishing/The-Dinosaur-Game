// The Trashcan Title Screen Test
...
bool ShowSplashScreen(void) {
	...
	if (SDL_Init(SDL_INIT_EVERYTHING) == 0) {
        ...
        if (window == NULL) {
			...
			dinosurf = SDL_LoadBMP("dinotitle.bmp");
			...
			if (dinosurf == NULL) {
	        	...
	        	spltexture = SDL_CreateTextureFromSurface(renderer, dinosurf);
